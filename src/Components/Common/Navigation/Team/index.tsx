...
// 			</p>
// 			<p className={classes.text}>
// 				For now, it's just me. My names <a href={'https://twitter.com/frompy_'} target={'blank'} className={classes.link}> Frompy </a>and I'm a web developer and kind of an artist? Idk. What my code produces is my art,
...
// 			</p>
// 			<p className={classes.text}>
// 				About a year ago I read an <a href={'https://kk.org/thetechnium/1000-true-fans/'} target={'blank'} className={classes.link}> article </a> referencing Kevin Kelly's (also my grandads name, oddly) idea of "A Thousand True Fans".
